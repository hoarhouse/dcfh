...
<body>
    ...
    <div class="breadcrumb">
        <div class="breadcrumb-container">
            ...
            <a href="../../blog/category.html?blog={blog_folder}">{blog_name or "Blog"}</a> <span>/</span>
            <span>{title}</span>
        </div>
    </div>
    ...
    <main class="main-container">
        ...
        <div class="post-footer">
            ...
            <a href="../../blog/category.html?blog={blog_folder}" class="back-to-blog">← Back to {blog_name or "Blog"}</a>
        </div>
    </main>
