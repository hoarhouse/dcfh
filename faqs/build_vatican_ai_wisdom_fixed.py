...
faq_content = """        <!-- Understanding Intelligence vs Wisdom -->
        ...
        <div class="faq-section" id="education">
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">According to the document, educational institutions should: (1) use AI as a tool while preserving human-centered learning, (2) emphasize capabilities AI cannot replicate—creativity, moral reasoning, wisdom, (3) teach critical evaluation of AI outputs and limitations, (4) maintain the centrality of human relationships in education, (5) focus on formation of character, not just skills transmission, and (6) cultivate humanistic education alongside technical training. Education must prepare students not just to use AI, but to guide it wisely.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">What is the danger of confusing AI intelligence with human wisdom?</h3>
                <p class="faq-answer">The Vatican document warns that confusing AI intelligence with wisdom risks: (1) delegating moral decisions to systems incapable of moral reasoning, (2) erosion of human responsibility and agency, (3) reducing complex human questions to technical problems, (4) loss of appreciation for dimensions of life AI cannot measure, and (5) creating dependence on systems that cannot understand authentic human flourishing. This confusion threatens to undermine the very wisdom needed to use AI well.</p>
        ...
        <div class="faq-section" id="related">
            ...
            <div class="faq-item">
                ...
                <p class="faq-answer">The AI and Wisdom document complements other Vatican teaching by focusing specifically on education, learning, and the cultivation of wisdom in the AI age. It connects to broader Vatican principles on human dignity, the importance of moral reasoning in technology development, and the need for wisdom to guide technical progress. This teaching emphasizes that technological capability must be balanced with ethical reflection and that education must cultivate wisdom alongside technical competence.</p>
            </div>

            <div class="faq-item">
                <h3 class="faq-question">Where can I learn more about Vatican AI ethics teaching?</h3>
                <p class="faq-answer">Explore our complete collection of Vatican AI ethics FAQs including the <a href="vatican-ai-peace-2024-faq.html">2024 World Day of Peace message on AI</a>, <a href="vatican-g7-ai-address-2024-faq.html">Pope Francis's historic G7 address</a>, <a href="vatican-communications-ai-wisdom-2024-faq.html">AI and Wisdom of the Heart</a>, and <a href="vatican-child-dignity-digital-world-2019-faq.html">Child Dignity in the Digital World</a>. These documents together provide comprehensive Catholic teaching on technology, human dignity, and the common good.</p>
            </div>
        </div>
"""
...
print("📊 Stats: 15 questions, 5 sections, working internal FAQ links")
